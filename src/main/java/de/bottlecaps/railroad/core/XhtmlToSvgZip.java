...
public class XhtmlToSvgZip
{
  ...
  public XhtmlToSvgZip()
  {
  }

  private void toSvg(XdmNode svg, OutputStream os) throws Exception
  {
  ...
  public void convert(Source source, OutputStream zip) throws Exception
  {
    ...
    evaluator.setExternalVariable(new QName("format"), new XdmAtomicValue("svg"));
